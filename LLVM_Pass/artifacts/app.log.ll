...
@0 = private unnamed_addr constant [5 x i8] c"sdiv\00", align 1
...
@7 = private unnamed_addr constant [5 x i8] c"urem\00", align 1
@8 = private unnamed_addr constant [5 x i8] c"udiv\00", align 1
@9 = private unnamed_addr constant [4 x i8] c"mul\00", align 1
@10 = private unnamed_addr constant [3 x i8] c"or\00", align 1
@11 = private unnamed_addr constant [5 x i8] c"zext\00", align 1
@12 = private unnamed_addr constant [7 x i8] c"select\00", align 1
@13 = private unnamed_addr constant [4 x i8] c"and\00", align 1
...
@16 = private unnamed_addr constant [5 x i8] c"call\00", align 1
@17 = private unnamed_addr constant [7 x i8] c"alloca\00", align 1
@18 = private unnamed_addr constant [4 x i8] c"add\00", align 1
@19 = private unnamed_addr constant [3 x i8] c"br\00", align 1
@20 = private unnamed_addr constant [5 x i8] c"icmp\00", align 1
...
3:                                                ; preds = %1, %3
  ...
  call void @instrLogger(ptr @13, ptr @16)
  %6 = and i32 %5, 1
  call void @instrLogger(ptr @15, ptr @18)
  %7 = getelementptr inbounds i32, ptr %0, i64 %4
  call void @instrLogger(ptr @14, ptr @13)
  call void @instrLogger(ptr @14, ptr @15)
  store i32 %6, ptr %7, align 4, !tbaa !5
  call void @instrLogger(ptr @18, ptr @18)
  %8 = add nuw nsw i64 %4, 1
  call void @instrLogger(ptr @20, ptr @18)
  %9 = icmp eq i64 %8, 10000
  call void @instrLogger(ptr @19, ptr @20)
...
define dso_local void @paintXY(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = srem i32 %0, 100
  %4 = sdiv i32 %0, 100
  call void @instrLogger(ptr @9, ptr @1)
  %5 = mul nsw i32 %3, 10
  call void @instrLogger(ptr @10, ptr @9)
  %6 = or disjoint i32 %5, 1
  call void @instrLogger(ptr @9, ptr @0)
  %7 = mul nsw i32 %4, 10
  call void @instrLogger(ptr @10, ptr @9)
  %8 = or disjoint i32 %7, 1
  call void @instrLogger(ptr @16, ptr @10)
  call void @instrLogger(ptr @16, ptr @10)
...
define dso_local i32 @countNeighbours(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #3 {
  %3 = srem i32 %1, 100
  %4 = sdiv i32 %1, 100
  call void @instrLogger(ptr @18, ptr @0)
  %5 = add nsw i32 %4, 99
  call void @instrLogger(ptr @1, ptr @18)
  %6 = srem i32 %5, 100
  call void @instrLogger(ptr @9, ptr @1)
  %7 = mul nsw i32 %6, 100
  call void @instrLogger(ptr @18, ptr @0)
  ...
  call void @instrLogger(ptr @18, ptr @1)
  %11 = add nsw i32 %3, 99
  call void @instrLogger(ptr @18, ptr @1)
  %12 = add nsw i32 %3, -1
  call void @instrLogger(ptr @20, ptr @18)
  %13 = icmp ult i32 %11, 100
  call void @instrLogger(ptr @12, ptr @20)
  call void @instrLogger(ptr @12, ptr @18)
  call void @instrLogger(ptr @12, ptr @18)
  %14 = select i1 %13, i32 %11, i32 %12
  call void @instrLogger(ptr @6, ptr @1)
  %15 = trunc i32 %3 to i8
  call void @instrLogger(ptr @18, ptr @6)
  %16 = add nsw i8 %15, 1
  call void @instrLogger(ptr @1, ptr @18)
  %17 = srem i8 %16, 100
  call void @instrLogger(ptr @2, ptr @1)
  %18 = sext i8 %17 to i32
  call void @instrLogger(ptr @9, ptr @0)
  %19 = mul nsw i32 %4, 100
  call void @instrLogger(ptr @18, ptr @9)
  call void @instrLogger(ptr @18, ptr @12)
  %20 = add nsw i32 %7, %14
  call void @instrLogger(ptr @2, ptr @18)
  %21 = sext i32 %20 to i64
  call void @instrLogger(ptr @15, ptr @2)
  %22 = getelementptr inbounds i32, ptr %0, i64 %21
  call void @instrLogger(ptr @5, ptr @15)
  ...
  call void @instrLogger(ptr @18, ptr @5)
  call void @instrLogger(ptr @18, ptr @5)
  %28 = add nsw i32 %27, %23
  call void @instrLogger(ptr @18, ptr @9)
  call void @instrLogger(ptr @18, ptr @2)
  %29 = add nsw i32 %7, %18
  call void @instrLogger(ptr @2, ptr @18)
  ...
  call void @instrLogger(ptr @3, ptr @18)
  ret i32 %58
}
...
define dso_local void @NextStep(ptr nocapture noundef %0) local_unnamed_addr #4 {
  ...
  call void @instrLogger(ptr @16, ptr @17)
...
3:                                                ; preds = %1, %12
  %4 = phi i64 [ 0, %1 ], [ %16, %12 ]
  call void @instrLogger(ptr @6, ptr @18)
  %5 = trunc i64 %4 to i32
  call void @instrLogger(ptr @16, ptr @6)
  %6 = tail call i32 @countNeighbours(ptr noundef %0, i32 noundef %5) #9
  call void @instrLogger(ptr @4, ptr @16)
...
7:                                                ; preds = %3
  ...
  call void @instrLogger(ptr @20, ptr @5)
  %10 = icmp eq i32 %9, 1
  br label %12
...
12:                                               ; preds = %3, %11, %7
  ...
  call void @instrLogger(ptr @11, ptr @20)
  %14 = zext i1 %13 to i32
  call void @instrLogger(ptr @15, ptr @17)
  call void @instrLogger(ptr @15, ptr @18)
  %15 = getelementptr inbounds [10000 x i32], ptr %2, i64 0, i64 %4
  call void @instrLogger(ptr @14, ptr @11)
  call void @instrLogger(ptr @14, ptr @15)
...
3:                                                ; preds = %1, %3
  ...
  call void @instrLogger(ptr @7, ptr @6)
  %9 = urem i16 %8, 100
  call void @instrLogger(ptr @8, ptr @6)
  %10 = udiv i16 %8, 100
  call void @instrLogger(ptr @9, ptr @7)
  %11 = mul nuw nsw i16 %9, 10
  call void @instrLogger(ptr @10, ptr @9)
  %12 = or disjoint i16 %11, 1
  call void @instrLogger(ptr @11, ptr @10)
  %13 = zext nneg i16 %12 to i32
  call void @instrLogger(ptr @9, ptr @8)
  ...
  call void @instrLogger(ptr @16, ptr @11)
  call void @instrLogger(ptr @16, ptr @11)
  call void @instrLogger(ptr @16, ptr @12)
...
declare void @instrLogger(ptr, ptr)
