...
define dso_local void @paintXY(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  ...
  tail call void @fillRect(i32 noundef %6, i32 noundef %8, i32 noundef 9, i32 noundef 9, i32 noundef %1) #6
  ret void
}
...
6:                                                ; preds = %3
  ...
  %8 = tail call i32 @countNeighbours(ptr noundef %0, i32 noundef %7) #8
...
14:                                               ; preds = %6, %13, %9
  %15 = phi i1 [ true, %6 ], [ %12, %9 ], [ false, %13 ]
  %16 = zext i1 %15 to i32
  %17 = getelementptr inbounds [10000 x i32], ptr %2, i64 0, i64 %4
  store i32 %16, ptr %17, align 4, !tbaa !5
  %18 = add nuw nsw i64 %4, 1
  br label %3, !llvm.loop !11

19:                                               ; preds = %3, %23
  %20 = phi i64 [ %27, %23 ], [ 0, %3 ]
  %21 = icmp eq i64 %20, 10000
...
23:                                               ; preds = %19
  %24 = getelementptr inbounds [10000 x i32], ptr %2, i64 0, i64 %20
  %25 = load i32, ptr %24, align 4, !tbaa !5
  %26 = getelementptr inbounds i32, ptr %0, i64 %20
...
6:                                                ; preds = %2
  ...
  %11 = select i1 %9, i32 -1, i32 -16764058
  tail call void @paintXY(i32 noundef %10, i32 noundef %11) #8
...
define dso_local void @app() local_unnamed_addr #0 {
  ...
  call void @GenerateStartPosition(ptr noundef nonnull %1) #8
  br label %2
...
6:                                                ; preds = %2
  call void @DrawField(ptr noundef nonnull %1) #8
  call void @NextStep(ptr noundef nonnull %1) #8
...
attributes #3 = { minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #4 = { minsize nofree norecurse nosync nounwind optsize memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
